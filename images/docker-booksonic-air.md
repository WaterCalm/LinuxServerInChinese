...
直接拉取 `ghcr.io/linuxserver/booksonic-air` 应该就可以自动获取适合你系统架构的版本，当然你也可以通过 tag 获取特定的版本。
...
```shell
docker pull ghcr.io/linuxserver/booksonic-air
```
...
- 查看镜像版本号：
  - `docker inspect -f '{% raw %}{{% endraw %}{ index .Config.Labels "build_version" }}' ghcr.io/linuxserver/booksonic-air`
